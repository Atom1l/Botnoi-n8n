...
const translations = {
  en: {
    ...
    'landing.tryitdetails': 'Try our Botnoivoice Text-to-Speech',
  ...
  th: {
    ...
    'landing.getapikeydetails': 'รับ API Key และไปยังเว็บไซต์ของเรา',
    'landing.tryitdetails': 'ทดลองใช้งาน Botnoivoice Text-to-Speech',
