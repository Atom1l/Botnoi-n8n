...
const translations = {
  ...
  th: {
    ...
    'landing.subtitle': 'แปลงข้อความเป็นเสียงพูดที่สมจริงได้อย่างง่ายดาย <br/> ช่วยให้คุณทำงานได้อย่างราบรื่น เสร็จงานได้ง่าย และทำได้ทุกที่',
