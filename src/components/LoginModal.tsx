      ...
      <div className="relative w-full max-w-md mx-auto">
        ...
        <div className="relative group">
          ...
          <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 overflow-hidden">
            ...
            <button
              onClick={onClose}
              className="absolute top-4 right-4 z-10 text-gray-400 hover:text-gray-600 transition-all duration-300 p-2 rounded-full hover:bg-gray-100/50 transform hover:scale-110"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <div className="relative px-8 pt-8 pb-6 text-center">
              ...
              <div className="relative mb-6">
                ...
                <div className="relative bg-white rounded-full p-4 shadow-xl border-4 border-white/80 mx-auto w-24 h-24 flex items-center justify-center">
                  <img 
                    src="/botnoi.svg" 
                    alt="Botnoi" 
                    className="h-12 w-12 transition-transform duration-300 transform hover:scale-110"
                  />
                </div>
              </div>
              ...
              <div className="relative">
                <h2 className={`text-2xl md:text-3xl font-black mb-2 bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 bg-clip-text text-transparent ${language === 'th' ? 'font-thai' : 'font-en'}`}>
                  {t('landing.welcome')}
                </h2>
                <p className={`text-gray-600 text-sm md:text-base ${language === 'th' ? 'font-thai' : 'font-en'}`}>
            ...
            <div className="px-8 pb-8">
              <div className="space-y-4">
                ...
                <div className="relative group">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="relative w-full bg-white border-2 border-gray-200 text-gray-700 px-6 py-4 rounded-xl hover:border-gray-300 hover:shadow-lg transition-all duration-300 flex items-center justify-center space-x-3 disabled:opacity-50 transform hover:scale-[1.02] group"
                  >
                    ...
                    <span className={`font-medium ${language === 'th' ? 'font-thai' : 'font-en'}`}>
                ...
                <div className="relative group">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="relative w-full bg-gradient-to-r from-green-500 to-green-600 text-white px-6 py-4 rounded-xl hover:from-green-600 hover:to-green-700 transition-all duration-300 flex items-center justify-center space-x-3 disabled:opacity-50 transform hover:scale-[1.02] shadow-lg"
                  >
                ...
                <div className="relative my-6">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className={`px-4 bg-white text-gray-500 font-medium ${language === 'th' ? 'font-thai' : 'font-en'}`}>
                ...
                <form onSubmit={handleEmailLogin} className="space-y-5">
                  {/* Email Field */}
                  <div>
                    <label htmlFor="email" className={`block text-sm font-semibold text-gray-700 mb-2 ${language === 'th' ? 'font-thai' : 'font-en'}`}>
                      {t('landing.emailAddress')}
                    </label>
                    <div className="relative group">
                      <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-xl blur-sm opacity-0 group-focus-within:opacity-100 transition-all duration-300"></div>
                      <input
                        id="email"
                        type="email"
                        value={email}
                        onChange={(e) => setEmail(e.target.value)}
                        className="relative w-full px-4 py-4 pl-12 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all duration-300 bg-white/80 backdrop-blur-sm"
                  ...
                  {/* Password Field */}
                  <div>
                    <label htmlFor="password" className={`block text-sm font-semibold text-gray-700 mb-2 ${language === 'th' ? 'font-thai' : 'font-en'}`}>
                      {t('landing.password')}
                    </label>
                    <div className="relative group">
                      <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-xl blur-sm opacity-0 group-focus-within:opacity-100 transition-all duration-300"></div>
                      <input
                        ...
                        className="relative w-full px-4 py-4 pr-12 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all duration-300 bg-white/80 backdrop-blur-sm"
                      ...
                      <button
                        ...
                        className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-blue-600 transition-colors duration-300 p-1 rounded-lg hover:bg-blue-50"
                      >
                  ...
                  <div className="relative group">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className={`relative w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-4 rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 disabled:opacity-50 transform hover:scale-[1.02] shadow-lg font-semibold flex items-center justify-center space-x-2 ${language === 'th' ? 'font-thai' : 'font-en'}`}
                    >
                      {loading ? (
                        <>
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200/50">
                <div className="flex items-center space-x-2">
                  ...
                  <p className={`text-xs text-green-800 ${language === 'th' ? 'font-thai' : 'font-en'}`}>
