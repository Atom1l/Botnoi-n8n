      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-32 bg-white/95 backdrop-blur-xl rounded-xl shadow-2xl border border-white/30 py-2 z-[9999]">
          ...
          <button
            ...
            className={`flex items-center space-x-2 w-full px-0 py-0 text-left hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition-all duration-300 rounded-lg mx-1 ${
