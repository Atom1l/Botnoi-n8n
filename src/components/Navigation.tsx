...
import { Copy, Eye, EyeOff, RefreshCw, CheckCircle, Settings, Zap, Book, Key, LogIn } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const maskKey = (key: string) => {
    if (!key) return 'Please login to get your API key';
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`text-2xl font-bold ${user ? 'text-green-600' : 'text-gray-400'} ${language === 'th' ? 'font-thai' : 'font-en'}`}>
                  {user ? t('dashboard.active') : 'Inactive'}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {user && apiKey.lastUsed ? apiKey.lastUsed.toLocaleDateString() : t('dashboard.never')}
                </p>
              </div>
