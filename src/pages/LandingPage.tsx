      ...
      <div className="relative w-full max-w-[calc(100vw-1rem)] sm:max-w-md mx-auto max-h-[95vh] overflow-y-auto">
        ...
        <div className="relative group">
          ...
          <div className="relative bg-white/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-2xl border border-white/50 overflow-hidden">
            ...
            <button
              onClick={onClose}
              className="absolute top-3 right-3 sm:top-4 sm:right-4 z-10 text-gray-400 hover:text-gray-600 transition-all duration-300 p-1.5 sm:p-2 rounded-full hover:bg-gray-100/50 transform hover:scale-110"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <div className="relative px-4 sm:px-8 pt-6 sm:pt-8 pb-4 sm:pb-6 text-center">
              ...
              <div className="relative mb-4 sm:mb-6">
                ...
                <div className="relative bg-white rounded-full p-3 sm:p-4 shadow-xl border-4 border-white/80 mx-auto w-20 h-20 sm:w-24 sm:h-24 flex items-center justify-center">
                  <img 
                    src="/botnoi.svg" 
                    alt="Botnoi" 
                    className="h-10 w-10 sm:h-12 sm:w-12 transition-transform duration-300 transform hover:scale-110"
                  />
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <p className={`text-gray-600 text-xs sm:text-sm md:text-base ${language === 'th' ? 'font-thai' : 'font-en'}`}>
            ...
            <div className="px-4 sm:px-8 pb-4 sm:pb-8">
              <div className="space-y-3 sm:space-y-4">
                ...
                <form onSubmit={handleEmailLogin} className="space-y-3 sm:space-y-5">
                  {/* Email Field */}
                  <div>
                    <label htmlFor="email" className={`block text-xs sm:text-sm font-semibold text-gray-700 mb-1.5 sm:mb-2 ${language === 'th' ? 'font-thai' : 'font-en'}`}>
                  ...
                  {/* Password Field */}
                  <div>
                    <label htmlFor="password" className={`block text-xs sm:text-sm font-semibold text-gray-700 mb-1.5 sm:mb-2 ${language === 'th' ? 'font-thai' : 'font-en'}`}>
                      {t('landing.password')}
                    </label>
                    <div className="relative group">
                      <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-xl blur-sm opacity-0 group-focus-within:opacity-100 transition-all duration-300"></div>
