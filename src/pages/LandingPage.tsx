    ...
    <div className="min-h-screen md:h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-md-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-5rem)] md:h-[calc(100vh-5rem)] px-4 sm:px-6 lg:px-8 md:overflow-hidden py-8 md:py-0">
        <div className="text-center mb-8 md:mb-8 max-w-5xl">
          ...
          <p className={`w-75 border border-red text-base md:text-base lg:text-lg text-gray-700 mb-6 md:mb-6 max-w-4xl mx-auto leading-relaxed ${language === 'th' ? 'font-thai' : 'font-en'}`}
